...
class HostingCommand extends Graf.Command {
  constructor(bot) {
    super(bot, {
      name: 'hosting',
      aliases: ['gimme hosting', 'get hosting'],
      module: 'general',
      memberName: 'hosting',
      description: 'Hosting recommendations for NodeJS :)'
    });
  }

  run() {
    return Promise.resolve({ plain: HostingMessage });
  }
}
